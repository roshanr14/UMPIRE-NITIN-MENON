...
export default function LiveScoringView({
  ...
  return (
    <div className="space-y-3.5 sm:space-y-5 max-w-7xl mx-auto pb-16 font-sans">
      ...
      {match.status === 'innings_break' && (
        <motion.div
          ...
          className="p-4 sm:p-6 rounded-2xl sm:rounded-3xl glass-panel border border-cyan-400/40 shadow-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 relative overflow-hidden"
        >
          ...
          <button
            ...
            className="liquid-btn liquid-btn-primary w-full sm:w-auto px-5 sm:px-6 py-2.5 sm:py-3.5 rounded-xl sm:rounded-2xl font-bold text-xs sm:text-sm flex items-center justify-center gap-2 shrink-0 relative z-10"
          >
      ...
      {match.status === 'completed' && (
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          className="p-4 sm:p-6 rounded-2xl sm:rounded-3xl glass-panel border border-emerald-400/40 shadow-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 relative overflow-hidden"
        >
