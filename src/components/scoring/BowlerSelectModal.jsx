    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/75 backdrop-blur-md">
        <motion.div
          ...
          className="w-full max-w-lg max-h-[88vh] glass-panel-elevated border border-white/[0.18] rounded-2xl sm:rounded-3xl p-4 sm:p-7 shadow-2xl flex flex-col relative overflow-hidden font-sans"
        >
          {/* Header */}
